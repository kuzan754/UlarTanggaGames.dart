Penjelasan design
Game ular tangga ini kami design menggunakan 3 jenis design yaitu, Model View Control (MVC), Strategy Pattern, dan Open Closed Principle. 
...
kita dapat menghubungkan model dengan view dengan cara mendapatkan element yang ingin diubah. Design pada game ini 
menggunakan Open Closed Principle, karena OCP didefinisikan dengan “open for extention, closed for modification” maka design 
pada game ini kami buat seperti itu, contohnya kita dapat mengextention kelas – kelas yang bersifat interface 
atau abstrak, sehingga jika kita mau menambahkan fitur baru, kita tidak perlu memodifikasi code yang sudah ada, 
contohnya seperti kelas abstrak Player pada gambar dibawah ini. 
